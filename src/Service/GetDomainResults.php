...
class GetDomainResults
{
    ...
    public function __construct(GetDomainUrls $getDomainUrls, string $apiKey, int $requestRetries, int $poolRequestConcurrency)
    {
    ...
    public function getDomainResults(): ?array
    {
        if (!$this->apiKey) {
            return null;
        }
